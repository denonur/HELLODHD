...
class Bot(BaseBot):
    ...
    async def on_start(self, SessionMetadata: SessionMetadata) -> None:
        try:
            await self.highrise.walk_to(Position(10, 0, 1, "FrontLeft"))
    ...
    async def on_chat(self, user: User, message: str):
        try:
            ...
            _rid = "65cb660f17ec732d8fa50de3" #Room ID Here
            if message.lower().lstrip().startswith(("!invite", "-invite")):
                ...
                for user in users:
                    ...
                    __rid = "65cb660f17ec732d8fa50de3" #Room ID Here
                    try:
            ...
            if message.lower().lstrip().startswith(("-help", "!help")):
                await self.highrise.chat(f"\nHere are some commands:\n • !emote or -emote\n • !invite or -invite\n • !feedback\n • couple/friendly command\n   !flirt @username\n   !fight @username \n   !rock @username\n   Example : !flirt @Atekinz\n\nLeave a message to @atekinz for any further assistance.")

            if message.lower().lstrip().startswith("!feedback"):
                try:
                    await self.highrise.send_message(_id, "• [ Submit Feedback ]\nThank you for joining our room! We value your feedback. Please share your feedback/suggestions with @oxic to enhance our environment. Your input is valuable and will help us improve.\n\nHave a wonderful day/night!", "text")
                except:
            ...
            if message.lower().lstrip().startswith(("-emote", "!emote")):
                ...
                await self.highrise.send_whisper(user.id, "\n• Note that these commands will only work in room called Finve ❤️ by @OGTic. some emotes may not work due to restrictions.")
...
if __name__ == "__main__":
    room_id = "65cb660f17ec732d8fa50de3"
    token = "b350dbbbb343dcff86546906b33952416ce80933bea0419d45240756e45cc5dc"
